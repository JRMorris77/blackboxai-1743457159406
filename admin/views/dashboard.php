...
<div class="security-checker wrap">
    <div class="flex items-center justify-between mb-8">
        <h1 class="text-3xl font-bold text-gray-800">
            <span class="text-blue-600"><?php _e('Security', 'kws-security-checker'); ?></span> <?php _e('Checker', 'kws-security-checker'); ?>
            <span class="ml-2 text-yellow-500 text-xl"><?php echo \KWS_SECURITY_CHECKER_VERSION; ?></span>
        </h1>
